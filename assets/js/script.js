...
function styleTime() {
    for (let index = 9; index < 18; index++) {
        ...
        // console.log($("#900").attr("id"))
        if (100 * moment().format("H") < $("#" + 100 * index).attr("id")) {
            $("#" + 100 * index).addClass("future");
        }


        else if (100 * moment().format("H") > $("#" + 100 * index).attr("id")) {
            $("#" + 100 * index).addClass("past");
